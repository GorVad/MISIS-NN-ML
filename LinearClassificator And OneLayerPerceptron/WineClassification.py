...
wineDataSet = pd.read_csv("D:\PyCharm\MISIS-NN-ML\LinearClassificator And OneLayerPerceptron\DataSets\wine.csv", header=None)
x = wineDataSet.iloc[:, 5:7].values
y = wineDataSet.iloc[:, 0].values
